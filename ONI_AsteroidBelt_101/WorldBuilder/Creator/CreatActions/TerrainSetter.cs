...
namespace ONI_AsteroidBelt_101.WorldBuilder.Creator.CreatActions
{
    internal class TerrainSetter
    {
        ...
        public static void DrawCustomTerrain(Klei.Data data, Sim.Cell[] cells, float[] bgTemp, Sim.DiseaseCell[] dc, float[,] noiseMap, CommonWorld world, System.Random CreatorRandom)
        {
