...
namespace ONI_AsteroidBelt_101.WorldBuilder.Creator.CreatActions
{
    internal class CellsSeparater
    {
        ...
        private static void GetRandCenter(out Vector2I center, Common.Biome.BiomeLocationPattern location, CommonWorld world, System.Random CreatorRandom)
        {
            int xrand = CreatorRandom.Next(-world.Width / 15, world.Width / 15);
            int yrand = CreatorRandom.Next(-world.Height / 15, world.Height / 15);
            switch (location)
            {
                case Common.Biome.BiomeLocationPattern.Middle:
                    center = new Vector2I(world.Width / 2 + xrand, world.Height / 2 + yrand);
                    break;
                case Common.Biome.BiomeLocationPattern.Up:
                    center = new Vector2I(world.Width / 2 + xrand, world.Height - Math.Abs(yrand));
                    break;
                case Common.Biome.BiomeLocationPattern.Down:
                    center = new Vector2I(world.Width / 2 + xrand, Math.Abs(yrand));
                    break;
                case Common.Biome.BiomeLocationPattern.Left:
                    center = new Vector2I(Math.Abs(xrand), world.Height / 2 + yrand);
                    break;
                case Common.Biome.BiomeLocationPattern.Right:
        ...
        private static void PunctateSet(out HashSet<Vector2I> _area, Common.Biome.BiomeLocationPattern location, CommonWorld world, System.Random CreatorRandom)
        {
        ...
        private static void BulkSet(out HashSet<Vector2I> _area, Common.Biome.BiomeLocationPattern location, CommonWorld world, System.Random CreatorRandom)
        {
            _area = new HashSet<Vector2I>();
        ...
        private static void CircularSet(out HashSet<Vector2I> _area, Common.Biome.BiomeLocationPattern location, CommonWorld world, System.Random CreatorRandom)
        {
        ...
        private static void LowFullSet(out HashSet<Vector2I> _area, Common.Biome.BiomeLocationPattern location, CommonWorld world, System.Random CreatorRandom)
        {
            _area = new HashSet<Vector2I>();
        ...
        public static void SeparateCells(CommonWorld world, System.Random CreatorRandom)
        {
            ...
            foreach (var biome in world.Biomes)
            {
                ...
                {
                    case Common.Biome.BiomeBehaviorPattern.Circular:
                        CircularSet(out area, biome.LocationPattern, world, CreatorRandom);
                        break;
                    case Common.Biome.BiomeBehaviorPattern.Bulk:
                        BulkSet(out area, biome.LocationPattern, world, CreatorRandom);
                        break;
                    case Common.Biome.BiomeBehaviorPattern.Punctate:
                        PunctateSet(out area, biome.LocationPattern, world, CreatorRandom);
                        break;
                    case Common.Biome.BiomeBehaviorPattern.LowFull:
